...
def delete_health() -> dict[str, Any]:
    return {
        ...
        "service": "gmail-delete-control",
        "owner_only": True,
        "trash_supported": configured(),
        "permanent_delete_supported": configured(),
        "oauth_required": True,
    }
...
def trash_message(
    ...
    result = http_json(
        f"{GMAIL_API_BASE}/users/me/messages/{mid}/trash",
        method="POST",
