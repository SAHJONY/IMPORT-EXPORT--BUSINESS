...
def evaluate_production_readiness(*, runtime_ok: bool = True, e2e_ok: bool | None = None, connector_health: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    gates = [
        ...
        ReadinessGate("all_schemas_applied", _true("INSFORGE_SCHEMAS_APPLIED"), True, "All production schemas applied and checked", "Apply and verify every current InsForge schema, including identity_access.sql and country_activation.sql."),
        ...
        ReadinessGate("country_activation_governance", _true("COUNTRY_ACTIVATION_E2E_VERIFIED"), True, "Country/corridor activation and hypothetical-jurisdiction live-execution isolation verified", "Apply country_activation.sql; verify READY/LIMITED/BLOCKED derivation, owner approval, corridor fail-closed behavior and that HYPOTHETICAL jurisdictions cannot enter LIVE execution."),
