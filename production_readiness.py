...
def evaluate_production_readiness(
    *,
    ...
    gates = [
        ...
        ReadinessGate("public_rfq_attachment_security", storage_configured and _true("SIGNED_DOCUMENT_STORAGE_VERIFIED") and _true("DOCUMENT_MALWARE_SCAN_REQUIRED") and _present("MALWARE_SCAN_CALLBACK_SECRET"), True, f"Public RFQ attachments require signed storage + mandatory malware scan callback; callback configured={_present('MALWARE_SCAN_CALLBACK_SECRET')}", "Configure and verify a real malware scanner callback before exposing public RFQ file upload."),
