...
def test_track_prompt_car_sales_alias_matches_car_sale():
    # "car_sales" (emitted by the 360 sales loop) must get the car_sale prompt.
    a = ev._track_system_prompt("car_sales", "es", 1, "")
    b = ev._track_system_prompt("car_sale", "es", 1, "")
    assert a == b
    assert "VIN" in a
