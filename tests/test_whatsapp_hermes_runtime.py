...
def test_inbound_uses_sofia_hermes_runtime(monkeypatch):
    ...
    async def fake_generate(text, contact_name, owner_context=False, sender_phone=None, media=None):
        calls["generate"] = (text, contact_name, owner_context, sender_phone, media)
    ...
    assert calls["generate"] == ("Necesito aceite", "Cliente", False, "15551234567", None)
