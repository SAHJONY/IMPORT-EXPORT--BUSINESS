...
app = FastAPI(title="SAHJONY LLC Unified Trade API", version="7.1.0", docs_url=None, redoc_url=None)
...
async def crm_runtime_health():
    ...
    return {
        ...
        "cuba_department_permanent":True,"cuba_sofia_sales_os_bridge":True,"global_lead_search_control_plane":True,"energy_vertical_connected":True,
