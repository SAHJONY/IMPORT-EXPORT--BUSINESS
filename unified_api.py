...
app = FastAPI(title="SAHJONY LLC Unified Trade API", version="6.10.0", docs_url=None, redoc_url=None)
...
for subapp in (
    ...
    communications_app, communication_os_security_app, communication_os_app, direct_text_app, wifi_connectivity_app, cuba_communications_app, voice_inbound_app, voice_agent_app, direct_voice_app, voice_autonomy_app, whatsapp_voice_orchestrator_app, documents_app, document_storage_app, shipments_app, compliance_app, commercial_app, language_app, collaboration_app, finance_app,
