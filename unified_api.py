...
from voice_outbound_api import app as voice_outbound_app
...
app = FastAPI(title="SAHJONY LLC Unified Trade API", version="6.4.0", docs_url=None, redoc_url=None)
...
for subapp in (
    ...
    communications_app, voice_outbound_app, voice_agent_app, documents_app, document_storage_app, shipments_app, compliance_app, commercial_app, language_app, collaboration_app, finance_app,
    countries_app, cuba_current_app, cuba_transition_app, cuba_trade_desk_app, cuba_private_business_app, cuba_private_sector_lead_app, lead_scout_app, managed_trade_app, intermediary_app, global_sourcing_app, business_readiness_app, us_import_app,
