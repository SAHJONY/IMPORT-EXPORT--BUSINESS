...
app.add_api_route("/whatsapp/openclaw/heartbeat", hermes_heartbeat, methods=["POST"])
app.add_api_route("/whatsapp/openclaw/events", hermes_event, methods=["POST"])
app.add_api_route("/whatsapp/openclaw/outbox", hermes_outbox, methods=["GET"])
app.add_api_route("/whatsapp/openclaw/outbox/ack", hermes_outbox_ack, methods=["POST"])
