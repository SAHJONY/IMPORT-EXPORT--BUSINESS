...
def _task(context: str | None, language: str | None) -> str:
    ...
    return (
        ...
        "The post-call system may autonomously create or update a CRM prospect only from facts actually provided. Never invent identity, company, country, requirement, quantity, destination or qualification facts. "
