  ...
  return <main style={s.page}>
    ...
    <section style={s.panel}>
      ...
      <div style={s.grid3}>
        ...
        <a href="/owner/agent-command" style={s.actionCard}><strong>Control AI operations</strong><span>Monitor TinyFish, Codex, Remote Desktop, Opera fallback, permissions, health and evidence.</span><b>OPEN AGENT COMMAND →</b></a>
